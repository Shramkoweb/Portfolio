...
const inlineClasses =
  'inline-block text-sm text-gray-800 dark:text-gray-300 underline decoration-gray-300 dark:decoration-gray-600 decoration-1 underline-offset-[3px] transition-[text-decoration-color] duration-150 ease-out-expo hover:decoration-gray-500 dark:hover:decoration-gray-400';
