...
export function ThemeChanger() {
  ...
  return (
    <button
      ...
      type="button"
      className="ml-4 inline-flex h-11 w-11 items-center justify-center rounded-lg ring-gray-300 hover:ring-2 text-gray-800 dark:text-gray-200 transition-[box-shadow] duration-200 active:scale-[0.95]"
      onClick={handleClick}
    >
      {mounted &&
