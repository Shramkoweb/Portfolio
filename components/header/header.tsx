...
export function Header() {
  return (
    <header className="flex flex-col justify-center px-8" role="banner">
      <nav role="navigation" className="flex items-center justify-between w-full relative max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pt-8 pb-8 sm:pb-16  text-gray-900 bg-gray-50  dark:bg-gray-900 bg-opacity-60 dark:text-gray-100">
