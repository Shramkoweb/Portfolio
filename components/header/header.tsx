...
export function Header() {
  return (
    <header className="flex flex-col justify-center px-8" role="banner">
      <nav aria-label="Main" role="navigation" className="relative mx-auto flex w-full max-w-3xl items-center justify-between border-gray-200 bg-gray-50 bg-opacity-60 pt-8 pb-8 text-gray-900 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 sm:pb-16">
