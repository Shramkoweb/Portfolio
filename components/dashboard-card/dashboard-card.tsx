...
export function DashboardCard(props: DashboardCardProps) {
  ...
  return (
    <a
      ...
      aria-label={header}
    >
      <div className="w-full rounded-lg border border-gray-200 bg-white p-4 transition-shadow duration-200 hover:shadow-md hover:shadow-gray-200/50 dark:border-gray-800 dark:bg-gray-900 dark:hover:shadow-black/20">
