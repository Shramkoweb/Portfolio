      ...
      <Head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html:
              '{"@context":"https://schema.org","@type":"WebSite","name":"Serhii Shramko","url":"https://shramko.dev","description":"Serhii Shramko – Developer, writer, creator.","publisher":{"@type":"Person","name":"Serhii Shramko","url":"https://shramko.dev/about","image":{"@type":"ImageObject","url":"https://shramko.dev/static/images/twittersite.png","width":1269,"height":846},"sameAs":["https://github.com/shramkoweb","https://www.linkedin.com/in/shramko-dev/","https://www.instagram.com/serhii.shramko/"],"knowsAbout":["Frontend Development","TypeScript","JavaScript","React","Next.js","Redux","Redux-Saga","WCAG 2.1","Accessibility","CI/CD","Performance Optimization"],"jobTitle":"Senior Developer","worksFor":{"@type":"Organization","name":"MacPaw","url":"https://macpaw.com"},"email":"shramko.dev@gmail.com","award":[{"@type":"Award","name":"Mentorship Recognition","description":"Mentored more than 30 individuals in software development"}],"workLocation":{"@type":"Place","address":{"@type":"PostalAddress","addressLocality":"Boston","addressRegion":"MA","addressCountry":"US"}}},"mainEntityOfPage":{"@type":"WebPage","@id":"https://shramko.dev/about"},"potentialAction":{"@type":"SearchAction","target":"https://shramko.dev/search?query={search_term_string}","query-input":"required name=search_term_string"},"inLanguage":"en","alumniOf":{"@type":"CollegeOrUniversity","name":"Dnipro University of Technology","url":"https://nmu.org.ua/en/"}}',
          }}
        />
      </Head>
