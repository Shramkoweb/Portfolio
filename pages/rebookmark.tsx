        ...
        {status === 'success' ? (
          ...
          <form onSubmit={handleSubmit} aria-label="Join waitlist" className="not-prose flex flex-col md:flex-row gap-3 w-full">
            <input
              ...
              required
              className="flex-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-3 py-2 text-sm text-gray-900 dark:text-white placeholder-gray-400 transition-[border-color,box-shadow] duration-150 focus:border-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500 dark:focus:border-gray-400 dark:focus:ring-gray-400"
            />
            <button
              type="submit"
              disabled={status === 'loading'}
              className="rounded-lg bg-gray-800 dark:bg-gray-200 px-5 py-2 text-sm font-medium text-white dark:text-gray-900 hover:bg-gray-700 dark:hover:bg-gray-300 disabled:opacity-50 transition-[background-color,transform] duration-200 active:scale-[0.97]"
            >
