...
export const categoryToSeoData = {
  ...
  [PostCategory.Astro]: {
    ...
    description:
      'Dive into the features and benefits of the Astro framework with this comprehensive guide.',
    keywords: 'Astro, Frontend, Framework',
  },
  [PostCategory.JamsSack]: {
    title: 'Master Jamstack Technology: Complete Overview',
    description:
      'Learn about the Jamstack technology and how to leverage it effectively for your projects.',
    keywords: 'Jamstack, Development, Technology',
  },
  [PostCategory.CSS]: {
    title: 'CSS Tips to Elevate Web Design Style',
    description:
      'Find useful tips and techniques to enhance your web design using CSS.',
    keywords: 'CSS, Web Design, Development',
  },
  [PostCategory.HTML]: {
    title: 'HTML Essentials: Building Responsive Web Pages',
    description:
      'Essential tips and tutorials to create responsive web pages using HTML.',
    keywords: 'HTML, Markup, Web Development',
  },
  [PostCategory.Vercel]: {
    title: 'Vercel Deployment: Streamline Your Workflow',
    description:
      'Discover tips and techniques to streamline your deployment process with Vercel.',
  ...
  [PostCategory.Tutorial]: {
    ...
    description:
      'Dive into this comprehensive Tutorial guides for step-by-step tutorials on various tasks and topics.',
    keywords: 'Tutorial, Guides, Tutorial',
  },
  [PostCategory.UsefulResources]: {
    title: 'Top Resources to Enhance Development Arsenal',
    description:
      'Discover a collection of useful resources to elevate your skills and productivity in development.',
  ...
  [PostCategory.Node]: {
    ...
    description:
      'Explore Node.js development resources and tutorials to harness the power of Node.js for your projects.',
    keywords: 'Node.js, Development, Backend',
  },
  [PostCategory.Opinion]: {
    title: 'Opinion: Engage in Thought-Provoking Discussions',
    description:
      'Engage with my opinion pieces and join thought-provoking discussions on various topics in the industry.',
  ...
  [PostCategory.Productivity]: {
    ...
    description:
      'Discover tips and strategies to boost your productivity and efficiency in your development workflow.',
    keywords: 'Productivity, Development, Efficiency',
  },
  [PostCategory.Habits]: {
    title: 'Healthy Coding Habits: A Success Guide',
    description:
      'Learn about the importance of developing healthy coding habits for success in your coding journey.',
    keywords: 'Coding Habits, Development, Success',
  },
  [PostCategory.Tools]: {
    title: 'Top Development Tools to Enhance Workflow',
    description:
      'Explore essential tools and resources to enhance your development workflow and productivity.',
    keywords: 'Development Tools, Resources, Productivity',
  },
  [PostCategory.Certifications]: {
    title: 'Certification: Get Your Certification',
    description:
      'Get your certification from my collection of certification resources and tutorials.',
