...
export const categoryToSeoData = {
  [PostCategory.JS]: {
    title: 'JavaScript Tips and Tutorials: Improve Your Coding Skills',
  ...
  [PostCategory.TS]: {
    title: 'TypeScript Guide: Strengthen Your Web Development Projects',
  ...
  [PostCategory.JamsSack]: {
    title: 'Mastering Jamstack Technology: A Complete Overview',
  ...
  [PostCategory.CSS]: {
    title: 'CSS Tricks and Techniques: Elevate Your Web Design Style',
    description: 'Find useful tips and techniques to enhance your web design using CSS.',
    keywords: 'CSS, Web Design, Development',
  },
  [PostCategory.HTML]: {
    title: 'HTML Essentials: Build Responsive Web Pages with Ease',
  ...
  [PostCategory.ProjectSetup]: {
    title: 'Efficient Project Setup: Streamline Your Development Process',
  ...
  [PostCategory.Opinion]: {
    title: 'Opinion Pieces: Engage in Thought-Provoking Discussions',
  ...
  [PostCategory.Productivity]: {
    title: 'Boosting Productivity: Tips for Efficiency in Development',
  ...
  [PostCategory.Habits]: {
    title: 'Developing Healthy Coding Habits: A Guide for Success',
  ...
  [PostCategory.Tools]: {
    title: 'Essential Development Tools: Enhance Your Workflow',
